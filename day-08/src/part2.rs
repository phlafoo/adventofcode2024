...
pub fn process(input: &str) -> miette::Result<String> {
        ...
        .filter(|(_, &a)| a != b'.' && a != b'\n')
    {
        ...
        for &(xo, yo) in ants.iter() {
            ...
            // Check antinodes starting at other antenna
            let (mut nx, mut ny) = (xo, yo);
            while (0..dim_i32 - 1).contains(&nx) && (0..dim_i32 - 1).contains(&ny) {
            ...
            // Check antinodes starting at this antenna
